...
/**
 * POST /api/match
 * Handles resume upload and job description matching
 */
router.post("/", upload.single("resume"), async (req, res) => {
  try {
    ...
    // We pass req.file because the service now handles the buffer internally
    ...
    // 3️⃣ Extract skills using OpenAI
